  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Job Profile</h4>
      </div>
      <div class="modal-body">
       <!--  Form -->
 <form role="form" action="job_profile" method="post">

    <div class="form-group">
    <label for="exampleInputfname">Employee ID</label>
    <input type="number" class="form-control" id="emp_id	" name="emp_id	" placeholder="Employee ID">
  </div>
    <div class="form-group">
    <label for="exampleInputdate">Joining Date</label>
    <input type="date" class="form-control" id="joing_date" name="joing_date" placeholder="Joining Date">
  </div>
     <div class="form-group">
    <label for="exampleInputdate">Resign Date</label>
    <input type="date" class="form-control" id="resign_date" name="resign_date" placeholder="Resign Date">
  </div>
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="job_title" name="job_title" placeholder="Job Title">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" value="submit">Save changes</button>
          ...
          <h2 class="sub-header">Profiles</h2>
